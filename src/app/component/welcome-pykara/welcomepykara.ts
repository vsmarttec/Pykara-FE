...
export const WelcomePykaraData = [
...

    {
        ...
        isPOC: true,
        url: "https://pykara-py-learn.static.hf.space/",
        href: "/portfolio/py-learn",
        slug: "py-learn",
        image: {
            src: "/assets/pylearn.png",
            alt: "Py-Learn product image"
        },

        latestproduct: {
            name: "PY-Match",
            Subtitle: "AI Personality & Compatibility Platform",
            img: "/assets/portfolio-dy/py-match-dy.png",
            href: "/portfolio/py-match"
        },
        images: [
            { src: '/assets/pylearn.png', alt: 'Product view 1' },
            { src: '/assets/poc/Py-learn/Py-learn-1.png', alt: 'Product view 2' },
            { src: '/assets/poc/Py-learn/Py-learn-2.png', alt: 'Product view 2' },
            { src: '/assets/poc/Py-learn/Py-learn-3.png', alt: 'Product view 2' },

        ],
        hero: {
            title: 'PY-Learn',
            subtitle: 'An AI-driven language learning platform aligned with school curricula',
            description:
                'A structured self-learning system that adapts to each student using AI-based evaluation and controlled progression.'
        },
        ...
        aiArchitecture: {
            modelsUsed: [
                ...
                'NLP models for grammar and reading analysis',
                'Adaptive difficulty scoring models'
            ],
            intelligenceLogic: [
        ...
        keyCapabilities: [
            ...
            'Teacher dashboards with insights and recommendations',
            'Homework mode and classroom mode',
            'Multi-language expansion support'
        ],

        teacherFeatures: [
            'Progress tracking and skill-level reports',
            'Common error identification',
            'Teacher voice narration (on/off)',
            'Tutor video explanations inside activities',
            'Admin override for syllabus restrictions'
        ],
        ...
        privacyAndSecurity: [
            ...
            'No cross-student learning leakage'
        ],
...

    {
        ...
        isPOC: true,
        url: "https://pykara-py-match.static.hf.space/",
        href: "/portfolio/py-match",
        slug: "py-match",
        images: [
            { src: '/assets/poc/py-match/image (1).png', alt: 'Product view 1' },
            { src: '/assets/poc/py-match/image (2).png', alt: 'Product view 3' },
            { src: '/assets/poc/py-match/image (3).png', alt: 'Product view 4' },
            { src: '/assets/poc/py-match/image (4).png', alt: 'Product view 5' },
            { src: '/assets/poc/py-match/image.png', alt: 'Product view 5' },

        ],
        image: {
            src: "/assets/py-match.png",
            alt: "Py-Match product image"
        },

        latestproduct: {
            name: "PY-Learn",
            Subtitle: "AI Learning Platform",
            img: "/assets/portfolio-dy/py-learn-dy.png", href: "/portfolio/py-learn"
        },
        hero: {
            title: 'PY-Match',
            subtitle: 'AI-driven personality and compatibility matching system',
            description:
                'A structured matching platform that evaluates personality traits and expectations using AI-based assessments.'
        },
        ...
        aiArchitecture: {
            modelsUsed: [
                'LLM-based situational assessment models',
                'Personality vector embedding models',
                'Compatibility scoring logic'
            ],
            intelligenceLogic: [
                'Brain-color personality evaluation',
                'Expectation-based filtering',
                'Combined character and expectation matching'
            ]
        },
        ...
        keyCapabilities: [
            ...
            'Combined matching with weighted scoring',
            'Ranked match results with explanations',
        ...
        integrationAndDeployment: {
            ...
            integrations: [
                ...
                'Custom profile management platforms'
            ]
        },

        privacyAndSecurity: [
            'User consent-based assessments',
...

    {
        ...
        isPOC: true,
        url: "https://pykara-py-detect.static.hf.space/",
        href: "/portfolio/py-detect",
        slug: "py-detect",
        image: {
            src: "/assets/pydetect-2.png",
            alt: "Py-Detect product image"
        },
        latestproduct: {
            name: "PY-Trade",
            Subtitle: "AI Market Analysis Platform",
            img: "/assets/portfolio-dy/PyTrade-dy.png", href: "/portfolio/py-trade"
        },
        images: [
            { src: '/assets/poc/py-detect/py-detect page.png', alt: 'Product view 1' },
            { src: '/assets/poc/py-detect/info page.png', alt: 'Product view 3' },
            { src: '/assets/poc/py-detect/py-detect page.png', alt: 'Product view 4' },
            { src: '/assets/poc/py-detect/question-summary page.png', alt: 'Product view 5' },
            { src: '/assets/poc/py-detect/record page.png', alt: 'Product view 5' },
            { src: '/assets/poc/py-detect/validation page.png', alt: 'Product view 5' },
            { src: '/assets/poc/py-detect/view details page.png', alt: 'Product view 5' },
        ],
        hero: {
            title: 'PY-Detect',
            subtitle: 'AI-assisted investigation and behavioral analysis system',
            description:
                'A secure investigation platform that supports structured questioning and behavioral signal analysis.'
        },
        ...
        aiArchitecture: {
            ...
            intelligenceLogic: [
                'RAG-based question grounding',
                'Voice tone and speed analysis',
                'Rule-based behavioral evaluation'
            ]
        },
        ...
        keyCapabilities: [
            ...
            'Secure case-wise data management'
        ],
        ...
        integrationAndDeployment: {
            ...
            integrations: [
                ...
                'Secure evidence storage platforms'
            ]
        },
